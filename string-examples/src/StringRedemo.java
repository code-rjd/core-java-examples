...
public class StringRedemo {
        ...
        public static void main(String[] args) {
            ...
            //stripLeading() - removes blank spaces before the actual content
            //stripTrailing() - removes blank spaces after the actual content
            ...
            // "equals" -  this checks the similarity in value
            ...
            //length - it gives the lenght of string
            System.out.println("indiaString.length(): " + indiaString.length());
            System.out.println("----------------------------------------");

            //replace - it replace all the character in the string woth the new one, keeping the rest same
            ...
            //substring - can extract required content from the string
            ...
            //concat - adding new content without replacing the original string with indiaString remaining immutable
            indiaString.concat(" new content ");
            System.out.println("indiaString.concat(): " + indiaString.concat(" new content "));
            System.out.println("----------------------------------------");

            //getBytes - converting to byte
